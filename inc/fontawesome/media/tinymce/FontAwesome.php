<?php 
// We need to bootstrap Wordpress so we can get the
// site URL & theme directory
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $theme_uri ?>/inc/fontawesome/media/font-awesome.min.css" />
    <style>
    ...
    <link rel="stylesheet" href="<?php echo $site ?>/wp-admin/css/farbtastic.css?v=<?php echo $version ?>" /> 
    <script src="<?php echo $site ?>/wp-includes/js/tinymce/tiny_mce_popup.js?v=<?php echo $version ?>"></script>
    <script src="<?php echo $site ?>/wp-includes/js/jquery/jquery.js?v=<?php echo $version ?>"></script>
    <script src="<?php echo $site ?>/wp-admin/js/farbtastic.js?v=<?php echo $version ?>"></script>
    <script>
        (function($){
