...
if ( !class_exists( 'OSFA_FontAwesome') ) {

	class OSFA_FontAwesome {
		...
		public function __construct() {
			$this->dir = get_template_directory_uri() . '/inc/fontawesome';
		...
		public function wp_enqueue_scripts() {
			wp_register_style( 'font-awesome', $this->dir . '/media/font-awesome.min.css' );
		...
		public function wp_head() {
			?>
			<!--[if IE 7]>
	            <link rel="stylesheet" type="text/css" media="all" href="<?php echo $this->dir . '/media/font-awesome-ie7.min.css' ?>" />
	        <![endif]-->
	        <?php 
		}
		...
		public function mce_css( $css ) {
			...
			$css .= $this->dir . '/media/font-awesome.min.css';
			return $css;
		}
		...
		public function mce_external_plugins( $plugin_array ) {
			$plugin_array['fontawesome'] = $this->dir . '/media/tinymce/editor-styles.js';
			return $plugin_array;
		}
